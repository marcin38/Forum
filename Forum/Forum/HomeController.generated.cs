...
namespace Forum.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : Forum.Controllers.HomeController
    {
        ...
        [NonAction]
        partial void SearchOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string searchBy, string search, int? page);

        [NonAction]
        public override System.Web.Mvc.ActionResult Search(string searchBy, string search, int? page)
        {
            ...
            SearchOverride(callInfo, searchBy, search, page);
            return callInfo;
        }
