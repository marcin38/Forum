...
namespace Forum.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CategoryController : Forum.Controllers.CategoryController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Domain.Models.Category category);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(Domain.Models.Category category)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Domain.Models.Category category);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(Domain.Models.Category category)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "category", category);
            EditOverride(callInfo, category);
            return callInfo;
        }
